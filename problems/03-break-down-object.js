...
console.log(breakDownObj({ name: 'Rupert', age: 5, speak: 'Meow' })); // => [ 'name', 'age', 'speak', 'Rupert', 5, 'Meow' ]
console.log(breakDownObj({ location: 'NY', borough: 'Brooklyn' })); // => [ 'location', 'borough', 'NY', 'Brooklyn' ]
